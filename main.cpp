...
drawstring(200.0,610.0,0.0,"Methods in OpenGL");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"Press the mapped key to navigate to the reference page:");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0," a -> glBegin                                     b -> glClear                    c -> glClearColor");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0," d -> glEnable                                     e -> glFlush                    f -> glColor");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0," g -> glMatrixMode                         h -> glLoadIdentity                   i -> glOrtho");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,460.0,0.0," j -> glutMainLoop                            k -> glutInit                     l -> glutInitWindowSize ");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,430.0,0.0," m -> glutBitmapCharacter             n -> glutKeyboardFunc             o -> glutSwapBuffers");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,400.0,0.0," p -> glutInitDisplayMode             q -> glutCreateWindow             r -> glutReshapeFunc");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,370.0,0.0," s -> glutIdleFunc             t -> gluLookAt             u -> glut");
...
glColor3f(0.5,0.1,0.2);
drawstring(200.0,640.0,0.0,"The first version of OpenGL, version 1.0, was released in January 1992 by Mark Segal and Kurt Akeley.");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0," Since then, OpenGL has occasionally been extended by releasing a new version of the specification.");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"Such releases define a baseline set of features which all conforming graphics cards must support,");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0," and against which new extensions can more easily be written.");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0,"Each new version of OpenGL tends to incorporate several extensions which have widespread support");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"among graphics-card vendors, although the details of those extensions may be changed.");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(200.0,640.0,0.0,"Alongside the release of OpenGL 1.5, the ARB released the OpenGL Shading Language specification,");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0,"and the extensions ARB_shader_objects, ARB_vertex_shader, and ARB_fragment_shader.");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,570.0,0.0,"EXTESIONS ADDED IN THIS RELEASE:");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,540.0,0.0,"ARB_vertex_buffer_object : ");
glColor3f(0.5,0.1,0.8);
drawstring(250.0,520.0,0.0,"A new type of GL object, the 'buffer', which stores various types of data in fast video memory");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"ARB_occlusion_query : ");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,460.0,0.0,"The programmer may query whether or not a primitive was occluded during rendering");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,430.0,0.0,"EXT_shadow_funcs : ");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,400.0,0.0,"The abilities of the ARB_shadow extension are slightly extended.");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,640.0,0.0,"OPENGL 2.0 was released on September 7, 2004.");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0,"OpenGL 2.0 was originally conceived by 3Dlabs to address concerns that OpenGL was stagnating ");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"and lacked a strong direction. 3Dlabs proposed a number of major additions to the standard.");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0,"The final OpenGL 2.0 specification[31] includes support for GLSL.");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0,"EXTESIONS ADDED IN THIS RELEASE:");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"ARB_shader_objects,ARB_vertex_shader,ARB_fragment_shader,ARB_shading_language_100 : ");
glColor3f(0.5,0.1,0.8);
drawstring(220.0,460.0,0.0,"Provides direct access to programmable vertex and fragment processors");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,430.0,0.0,"ARB_texture_non_power_of_two : ");
glColor3f(0.5,0.1,0.8);
drawstring(220.0,400.0,0.0,"Texture images may have non-power-of-two dimensions ");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,370.0,0.0,"ARB_point_sprite");
glColor3f(0.5,0.1,0.8);
drawstring(220.0,340.0,0.0,"Points may be rendered as small, screen-oriented texture quads; useful when developing particle systems ");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,310.0,0.0,"EXT_stencil_two_side, ATI_separate_stencil : ");
glColor3f(0.5,0.1,0.8);
drawstring(220.0,280.0,0.0,"Separate stencil algorithms may be used when rendering the front and back faces of primitives");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,640.0,0.0,"OPENGL 3.0 was released on August 11, 2008. ");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0,"OpenGL 3.0 introduced a deprecation mechanism to simplify future revisions of the API.");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"Certain features, marked as deprecated, could be completely disabled by requesting a ");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0,"forward-compatible context from the windowing system. OpenGL 3.0 features could");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0,"still be accessed alongside these deprecated features, however, by requesting a full context.");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"Deprecated features include :");
glColor3f(0.5,0.1,0.9);
drawstring(220.0,460.0,0.0,"* All fixed-function vertex and fragment processing");
glColor3f(0.5,0.1,0.9);
drawstring(220.0,430.0,0.0,"* Direct-mode rendering, using glBegin and glEnd");
glColor3f(0.5,0.1,0.9);
drawstring(220.0,400.0,0.0,"* Display lists");
glColor3f(0.5,0.1,0.9);
drawstring(220.0,370.0,0.0,"* Indexed-color rendering targets");
glColor3f(0.5,0.1,0.9);
drawstring(220.0,340.0,0.0,"* OpenGL Shading Language versions 1.10 and 1.20");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,640.0,0.0,"OPENGL VERSION 4.0 was released on March 11, 2010");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0,"OpenGL 4.0 was released alongside version 3.3. It was designed for hardware able to support Direct3D 11.");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"As in OpenGL 3.0, this version of OpenGL contains a high number of fairly inconsequential extensions,");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0," designed to thoroughly expose the abilities of Direct3D 11-class hardware.");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0,"Hardware support: Nvidia GeForce 400 series and newer, AMD Radeon HD 5000 Series and newer, ");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"Intel HD Graphics in Intel Ivy Bridge processors and newer.");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,640.0,0.0,"OPENGL VERSION 4.5  was released on August 11, 2014");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0,"Direct State Access (DSA) – object accessors enable state to be queried and modified");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"without binding objects to contexts,for increased application,middleware efficiency and flexibility");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0,"Flush Control – applications can control flushing of pending commands before context switching.");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0,"Robustness – providing a secure platform for applications such as WebGL browsers.");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"OpenGL ES 3.1 API and shader compatibility – to enable the easy development and execution of the latest OpenGL ES applications");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,640.0,0.0,"OPENGL VERSION 4.6 was released on July 31, 2017");
glColor3f(0.5,0.1,0.3);
drawstring(200.0,610.0,0.0,"+ more efficient, GPU-sided, geometry processing");
glColor3f(0.5,0.1,0.4);
drawstring(200.0,580.0,0.0,"+ more efficient shader execution (AZDO)");
glColor3f(0.4,0.1,0.5);
drawstring(200.0,550.0,0.0,"+ more information through statistics, overflow query and counters");
glColor3f(0.5,0.1,0.8);
drawstring(200.0,520.0,0.0,"+ clamping of polygon offset function, solves a shadow rendering problem");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,490.0,0.0,"+ higher performance through no error handling contexts");
glFlush();
}
...
glColor3f(0.5,0.7,0.9);
drawstring(200.0,190.0,0.0,"PRESS 's' KEY TO NAVIGATE TO glutReshapeFunc specification");
glColor3f(0.5,0.1,0.2);
...
glColor3f(0.5,0.7,0.9);
drawstring(200.0,100.0,0.0,"PRESS 'o' KEY TO NAVIGATE TO glutReshapeFunc specification");
glColor3f(0.5,0.1,0.9);
drawstring(200.0,70.0,0.0,"");
glColor3f(0.5,0.7,0.9);

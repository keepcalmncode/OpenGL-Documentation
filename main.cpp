...
glColor3f(1,1,1);
drawstring(50.0,640.0,0.0,"PRESS NUMBER 1 - 7 TO TO KNOW THE HISTORY OF OPENGL MAJOR RELEASES");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,590.0,0.0,"Methods in OpenGL");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"Press the mapped key to navigate to the reference page:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,500.0,0.0," a -> glBegin                                     b -> glClear                    c -> glClearColor");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,450.0,0.0," d -> glEnable                                     e -> glFlush                    f -> glColor");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0," g -> glMatrixMode                         h -> glLoadIdentity                   i -> glOrtho");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,350.0,0.0," j -> glutMainLoop                            k -> glutInit                     l -> glutInitWindowSize ");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,300.0,0.0," m -> glutBitmapCharacter             n -> glutKeyboardFunc             o -> glutSwapBuffers");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,250.0,0.0," p -> glutInitDisplayMode             q -> glutCreateWindow             r -> glutReshapeFunc");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,200.0,0.0," s -> glutIdleFunc                     t -> gluLookAt             ");
...
drawstring(50.0,640.0,0.0,"OPENGL refers to Open Graphics Library");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,540.0,0.0,"It is a Cross-Language, Cross-Platform Application Programming Interface");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,500.0,0.0,"for rendering 2D and 3D vector graphics");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,460.0,0.0,"Since its introduction in 1992, OpenGL has become the industry's most widely used and supported ");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,420.0,0.0,"2D and 3D graphics application programming interface (API), bringing thousands of applications ");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,380.0,0.0,"to a wide variety of computer platforms.");
...
glColor3f(0.5,0.1,0.9);
drawstring(300.0,210.0,0.0,"| OPENGL 1.5                |  503                      |");
glColor3f(0.5,0.1,0.9);
drawstring(300.0,195.0,0.0,"+----------------+-------------+");
glColor3f(0.5,0.1,0.9);
drawstring(300.0,180.0,0.0,"| OPENGL 2.0                |  504                      |");
glColor3f(0.5,0.1,0.9);
drawstring(300.0,165.0,0.0,"+----------------+-------------+");
glColor3f(0.5,0.1,0.9);
drawstring(300.0,150.0,0.0,"| OPENGL 3.0                |  508                      |");
glColor3f(0.5,0.1,0.9);
...
glColor3f(0.5,0.1,0.2);
drawstring(50.0,650.0,0.0,"The first version of OpenGL, version 1.0, was released in January 1992 by Mark Segal and Kurt Akeley.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0," Since then, OpenGL has occasionally been extended by releasing a new version of the specification.");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"Such releases define a baseline set of features which all conforming graphics cards must support,");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0," and against which new extensions can more easily be written.");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,450.0,0.0,"Each new version of OpenGL tends to incorporate several extensions which have widespread support");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"among graphics-card vendors, although the details of those extensions may be changed.");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(50.0,650.0,0.0,"Alongside the release of OpenGL 1.5, the ARB released the OpenGL Shading Language specification,");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0,"and the extensions ARB_shader_objects, ARB_vertex_shader, and ARB_fragment_shader.");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"EXTESIONS ADDED IN THIS RELEASE:");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0,"ARB_vertex_buffer_object : ");
glColor3f(0.5,0.1,0.8);
drawstring(250.0,450.0,0.0,"A new type of GL object, the 'buffer', which stores various types of data in fast video memory");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"ARB_occlusion_query : ");
glColor3f(0.5,0.1,0.9);
drawstring(250.0,350.0,0.0,"The programmer may query whether or not a primitive was occluded during rendering");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,300.0,0.0,"EXT_shadow_funcs : ");
glColor3f(0.5,0.1,0.9);
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,650.0,0.0,"OPENGL 2.0 was released on September 7, 504.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0,"OpenGL 2.0 was originally conceived by 3Dlabs to address concerns that OpenGL was stagnating ");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"and lacked a strong direction. 3Dlabs proposed a number of major additions to the standard.");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0,"The final OpenGL 2.0 specification[31] includes support for GLSL.");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,450.0,0.0,"EXTESIONS ADDED IN THIS RELEASE:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"ARB_shader_objects,ARB_vertex_shader,ARB_fragment_shader,ARB_shading_language_100 : ");
glColor3f(0.5,0.1,0.8);
drawstring(220.0,350.0,0.0,"Provides direct access to programmable vertex and fragment processors");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,300.0,0.0,"ARB_texture_non_power_of_two : ");
glColor3f(0.5,0.1,0.8);
drawstring(220.0,250.0,0.0,"Texture images may have non-power-of-two dimensions ");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,50.0,0.0,"ARB_point_sprite");
glColor3f(0.5,0.1,0.8);
...
glColor3f(0.5,0.1,0.8);
drawstring(50.0,100.0,0.0,"EXT_stencil_two_side, ATI_separate_stencil : ");
glColor3f(0.5,0.1,0.8);
...
glColor3f(0.5,0.1,0.2);
drawstring(350.0,650.0,0.0,"OPENGL 3.0 was released on August 11, 508. ");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0,"OpenGL 3.0 introduced a deprecation mechanism to simplify future revisions of the API.");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"Certain features, marked as deprecated, could be completely disabled by requesting a ");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0,"forward-compatible context from the windowing system. OpenGL 3.0 features could");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,450.0,0.0,"still be accessed alongside these deprecated features, however, by requesting a full context.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"Deprecated features include :");
glColor3f(0.5,0.1,0.9);
...
glColor3f(0.5,0.1,0.9);
drawstring(220.0,50.0,0.0,"* Indexed-color rendering targets");
glColor3f(0.5,0.1,0.9);
...
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0,"OpenGL 4.0 was released alongside version 3.3. It was designed for hardware able to support Direct3D 11.");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"As in OpenGL 3.0, this version of OpenGL contains a high number of fairly inconsequential extensions,");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0," designed to thoroughly expose the abilities of Direct3D 11-class hardware.");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,450.0,0.0,"Hardware support: Nvidia GeForce 400 series and newer, AMD Radeon HD 5000 Series and newer, ");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"Intel HD Graphics in Intel Ivy Bridge processors and newer.");
glFlush();
}
...
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0,"Direct State Access (DSA) – object accessors enable state to be queried and modified");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"without binding objects to contexts,for increased application,middleware efficiency and flexibility");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0,"Flush Control – applications can control flushing of pending commands before context switching.");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,450.0,0.0,"Robustness – providing a secure platform for applications such as WebGL browsers.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"OpenGL ES 3.1 API and shader compatibility – to enable the easy development and execution of the latest OpenGL ES applications");
glFlush();
}
...
glColor3f(0.5,0.1,0.3);
drawstring(50.0,600.0,0.0,"+ more efficient, GPU-sided, geometry processing");
glColor3f(0.5,0.1,0.4);
drawstring(50.0,550.0,0.0,"+ more efficient shader execution (AZDO)");
glColor3f(0.4,0.1,0.5);
drawstring(50.0,500.0,0.0,"+ more information through statistics, overflow query and counters");
glColor3f(0.5,0.1,0.8);
drawstring(50.0,450.0,0.0,"+ clamping of polygon offset function, solves a shadow rendering problem");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,400.0,0.0,"+ higher performance through no error handling contexts");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"glBegin and glEnd delimit the vertices that define a primitive or a group of like primitives.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"glBegin accepts a single argument that specifies which way the vertices are interpreted.");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"void glBegin(GLenum mode)");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"PARAMETERS:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"Ten symbolic constants are accepted: GL_POINTS, GL_LINES, GL_LINE_STRIP, GL_LINE_LOOP, ");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"GL_TRIANGLES, GL_TRIANGLE_STRIP, GL_TRIANGLE_FAN, GL_QUADS, GL_QUAD_STRIP,");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,50.0,0.0," and GL_POLYGON.");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"clear buffers within the viewport");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"ERRORS:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"GL_INVALID_VALUE is generated if any bit other than the four defined bits is set in mask.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"GL_INVALID_OPERATION is generated if glClear is called between a call to glBegin");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,50.0,0.0," and the corresponding call to glEnd.");
glFlush();
}
...
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"enable or disable GL capabilities");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0,"ERRORS:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"GL_INVALID_ENUM is generated if cap is not one of the values listed above.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"GL_INVALID_OPERATION is generated if glEnable is called between a call to glBegin ");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"and the corresponding call to glEnd.");
glFlush();
}
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0," force execution of GL commands in finite time");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,220.0,0.0,"NOTES:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0,"glFlush does not wait until the execution of all previously issued OpenGL commands is complete.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"ERRORS:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"GL_INVALID_OPERATION is generated if glFlush is called between a call to");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0," glBegin and the corresponding call to glEnd.");
glColor3f(0.5,0.1,0.9);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"Used to set color to any object.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(50.0,220.0,0.0,"NOTES:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0,"The current color can be updated at any time. In particular, glColor can be called between a");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"glBegin and the corresponding call to glEnd.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"Example:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"glColor3f(1.0,0.0,0.0):");
glColor3f(0.5,0.1,0.9);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"specify which matrix is the current matrix");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(50.0,160.0,0.0,"ERRORS");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"GL_INVALID_ENUM is generated if mode is not an accepted value.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"GL_INVALID_OPERATION is generated if glMatrixMode is called between");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"a call to glBegin and the corresponding call to glEnd.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,50.0,0.0,"");
glFlush();
}
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"replace the current matrix with the identity matrix");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(50.0,130.0,0.0,"ERRORS:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"GL_INVALID_OPERATION is generated if glLoadIdentity is called between");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"a call to glBegin and the corresponding call to glEnd.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,50.0,0.0,"");
...
drawstring(50.0,190.0,0.0,"ERRORS:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"GL_INVALID_OPERATION is generated if glOrtho is executed between the ");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"execution	of glBegin and the corresponding execution of glEnd.");
glFlush();
}
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"enters the GLUT event processing loop.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"glutInit is used to initialize the GLUT library.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"glutInitWindowPosition and   glutInitWindowSize set the initial window position and size respectively.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"glutBitmapCharacter renders a bitmap character using OpenGL.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0," glutKeyboardFunc sets the keyboard callback for the current window.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"Creating Keyboard Function:");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"void my_keyboard(unsigned char key,int x, int y)");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"{ switch(key) {");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"case 'a': new_function();");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,50.0,0.0,"break; }");
glFlush();
}
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0," glutSwapBuffers swaps the buffers of the current window if double buffered. ");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"glutInitDisplayMode sets the initial display mode.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0,"");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"");
glColor3f(0.5,0.1,0.9);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"  glutCreateWindow creates a top-level window.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0," identifiers starts at one. This window identifier can be used when calling glutSetWindow.");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"");
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"  glutReshapeFunc sets the reshape callback for the current window.");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0," glutIdleFunc sets the global idle callback");
glColor3f(0.5,0.1,0.3);
drawstring(50.0,610.0,0.0,"USAGE:");
glColor3f(0.5,0.1,0.4);
...
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,640.0,0.0,"define a viewing transformation");
...
glColor3f(0.5,0.1,0.9);
drawstring(50.0,190.0,0.0,"	        // init GLUT and create window");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,160.0,0.0,"	        // register callbacks");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,130.0,0.0,"	        // enter GLUT event processing cycle");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,100.0,0.0,"}");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"");
glColor3f(0.5,0.7,0.9);
drawstring(50.0,50.0,0.0,"PRESS x TO GOTO NEXT SCREEN");
glFlush();
}
...
drawstring(50.0,50.0,0.0,"PRESS 'y' KEY TO GOTO NEXT SCREEN");
glFlush();
}
...
glColor3f(0.5,0.7,0.9);
drawstring(50.0,430.0,0.0," PRESS 'r' KEY TO NAVIGATE TO glutReshapeFunUSAGE");
glColor3f(0.5,0.1,0.9);
...
glColor3f(0.5,0.7,0.9);
drawstring(50.0,190.0,0.0,"PRESS 's' KEY TO NAVIGATE TO glutIdleFunUSAGE");
glColor3f(0.5,0.1,0.2);
drawstring(50.0,160.0,0.0,"NOTE ON DOUBLE BUFFERING");
glColor3f(0.5,0.1,0.9);
...
glColor3f(0.5,0.7,0.9);
drawstring(50.0,100.0,0.0,"PRESS 'o' KEY TO NAVIGATE TO glutSwapBuffers specification");
glColor3f(0.5,0.1,0.9);
drawstring(50.0,70.0,0.0,"");
glColor3f(0.5,0.7,0.9);
drawstring(50.0,50.0,0.0,"PRESS z TO GOTO NEXT SCREEN");
glFlush();
}
...
glColor3f(0.5,0.7,0.9);
drawstring(50.0,370.0,0.0,"PRESS 'n' KEY TO NAVIGATE TO glutKeyboardFunUSAGE ");
glColor3f(0.5,0.1,0.3);
...
glColor3f(0.5,0.7,0.9);
drawstring(50.0,30.0,0.0,"PRESS 't' KEY TO NAVIGATE TO gluLookAt specification ");
glFlush();
}
